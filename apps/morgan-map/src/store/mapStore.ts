...
import { axisToCanvas, canvasToAxis } from '../utils/coordinates';
...
export const useMapStore = create<MapStore>((set) => ({
  ...
  importMap: (data) => {
    set((state) => {
      // Auto-derive position and type from axis values so LLM-generated
      // maps don't need to calculate pixel coordinates manually.
